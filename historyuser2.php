<?php
    ...
    if(isset($_SESSION["username"]) && $namaakun == "staff"){
    }else{
...
<header>
        ...
        <ul class="navbar">
                <li><a href="staff.php"><i class="fa fa-fw fa-home"></i> Home</a></li>
                <li><a href="historyuser2.php"><i class="fa fa-fw fa-history"></i> Riwayat Login</a></li>
                <li><a href="historyproduct2.php"><i class="fa fa-fw fa-list"></i> Riwayat Pembelian</a></li>
                <li><a href="#"><i class="fa fa-fw fa-user"></i>Staff</a></li>
